...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Merriweather:ital,wght@0,300;0,400;0,700;1,400&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .container {{
            ...
            padding: 60px 80px;
            border-radius: 8px; /* Slight radius for modern feel, not too rounded */
        ...
        h1 {{
            ...
            padding-bottom: 15px;
            margin-top: 0.5em; /* Less margin for title at top */
        }}
        ...
        code {{
            ...
            color: #ef4444; /* Reddish for code inline */
            padding: 0.2em 0.4em;
            border-radius: 4px;
            font-size: 0.9em;
